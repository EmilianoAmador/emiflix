...
from emiflix.db.models import PublishStateOptions
...
class VideoModelTestCase(TestCase):
    def setUp(self):
        ...
        self.obj_b =Video.objects.create(title='This is my title', state=PublishStateOptions.PUBLISH, video_id='abcefg')
